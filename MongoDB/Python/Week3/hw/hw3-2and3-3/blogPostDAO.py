...
class BlogPostDAO:
    ...
    def insert_entry(self, title, post, tags_array, author):
        ...
        # now insert the post
        try:
            # DONE XXX HW 3.2 Work Here to insert the post
    ...
    def get_posts(self, num_posts):
        ...
        # DONE XXX HW 3.2 Work here to get the posts
    ...
    def get_post_by_permalink(self, permalink):
        ...
        post = None
        # DONE XXX Work here to retrieve the specified post
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            return result['nModified'] #last_error['n']          # return the number of documents updated
